...
const DataQuality_Filtering_Notes_Comp = () => {
    ...
    const formattedText = typeof DataQuality_Filtering_Notes === 'string'
        ? DataQuality_Filtering_Notes
    ...
    useEffect(() => {
        ...
        function callAxios() {
            axios
                .get(
                    `${BACKEND_API_URL}data_quality/notes?expt_id=${globalExperimentID}&data_quality_page=Filtering`,
                    {
                        headers: {
                ...
                .then((response) => {
                    ...
                    setDataQuality_Filtering_Notes(response.data.notes);
                    //console.log("Filtering Notes : ", response.data.notes);
                })
                .catch((error) => {
...
export default DataQuality_Filtering_Notes_Comp;
