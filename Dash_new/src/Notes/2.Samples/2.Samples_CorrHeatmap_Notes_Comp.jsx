...
const Samples_CorrHeatmap_Notes_Comp = () => {
    const { Samples_CorrelationHeatmap_Notes, globalExperimentID, setSamples_CorrelationHeatmap_Notes, jwt, isGotoExperimentClicked,
    ...
    const formattedText = typeof Samples_CorrelationHeatmap_Notes === 'string'
        ? Samples_CorrelationHeatmap_Notes
    ...
    useEffect(() => {
        ...
        function callAxios() {
            axios
                .post(
                    `${BACKEND_API_URL}samples/notes?expt_id=${globalExperimentID}&samples_page=correlation_heatmap`,
                    {
                ...
                .then((response) => {
                    ...
                    setSamples_CorrelationHeatmap_Notes(response.data.notes);
    ...
    }, [globalExperimentID, Samples_CorrelationHeatmap_CorrectionChoice, Samples_CorrelationHeatmap_GroupChoice, Samples_CorrelationHeatmap_GeneChoice, Samples_CorrelationHeatmap_LinkageChoice, Samples_PCA_GroupChoice])
...
export default Samples_CorrHeatmap_Notes_Comp;
