...
const Samples_PCA_Notes_Comp = () => {
    const { globalExperimentID, jwt, isGotoExperimentClicked,
        ...
        Samples_PCA_GroupChoice, Samples_PCA_Notes, setSamples_PCA_Notes } = useContext(GlobalContext);

    const formattedText = typeof Samples_PCA_Notes === 'string'
        ? Samples_PCA_Notes
    ...
    useEffect(() => {
        ...
        function callAxios() {
            axios
                .post(
                    `${BACKEND_API_URL}samples/notes?expt_id=${globalExperimentID}&samples_page=PCA`,
                    {
                ...
                .then((response) => {
                    ...
                    setSamples_PCA_Notes(response.data.notes);
...
export default Samples_PCA_Notes_Comp;
